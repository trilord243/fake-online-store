...
function Furnitures() {
    ...
    const Furnitures = context.items.filter(item => item.category.name === 'Furnitures')


    let searchedProducts = Furnitures.filter(item => item.title.toLowerCase().includes(value.toLowerCase()))
